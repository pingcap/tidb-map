...
- 3.1.1 修改 `decimal` 字段长度报错 `"ERROR 1105 (HY000): unsupported modify decimal column precision"`, 见案例 [case-1004](./diagnose-case-study/case1004.md)，TiDB 暂时不支持修改 `decimal` 字段长度。
